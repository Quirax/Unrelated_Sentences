...
-   데모 동영상 (1분 이내) 또는 스크린샷 (n장 가능)
-   자신의 소스코드를 Github 공개(예정)나 데모 동영상을 YouTube 공개 시 해당 URL을 포함합니다.
...
TODO: main.py 소스 정리 및 query.json 파일 대응
...
| 대학수학능력시험 6월/9월 모의평가 | 2003학년도 ~ 2022학년도 | 41개    | 훈련 데이터   |
| 대학수학능력시험                  | 1994학년도 ~ 2022학년도 | 28개    | 테스트 데이터 |
...
4. 위의 대명사 문제와 관련하여, 현재 본 프로젝트에서는 그러한 맥락을 온전히 반영하지 못하는 문제가 있습니다.
   하다못해 해당 대명사들이 가리키는 단어로 치환하여 정확도를 향상시키는 방안이 있을 수 있습니다.
